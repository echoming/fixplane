...
static const char OHOS_MANUFACTURE[] = {"HOPERUN"};
static const char OHOS_BRAND[] = {"HiHope"};
static const char OHOS_MARKET_NAME[] = {"Neptune"};
static const char OHOS_PRODUCT_SERIES[] = {"HH"};
static const char OHOS_PRODUCT_MODEL[] = {"HH-SLNTP100"};
static const char OHOS_SOFTWARE_MODEL[] = {"****"};
static const char OHOS_HARDWARE_MODEL[] = {"****"};
static const char OHOS_HARDWARE_PROFILE[] = {"H1000"};
static const char OHOS_BOOTLOADER_VERSION[] = {"NA"};
static const char OHOS_SECURITY_PATCH_TAG[] = {"NA"};
static const char OHOS_ABI_LIST[] = {"csky-liteos"};
